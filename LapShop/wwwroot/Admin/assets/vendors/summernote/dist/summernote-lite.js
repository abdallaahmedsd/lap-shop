...
function eq(elementA) {
  return function (elementB) {
    return elementA === elementB;
  };
}

function eq2(elementA, elementB) {
  return elementA === elementB;
}

function peq2(propName) {
  return function (elementA, elementB) {
    return elementA[propName] === elementB[propName];
  };
}
...
function lists_next(array, element) {
  if (array && array.length && element) {
...
/**
 * returns prev element.
 * @param {Array} array
 */


function prev(array, element) {
  if (array && array.length && element) {
    var idx = array.indexOf(element);
    return idx === -1 ? null : array[idx - 1];
  }
...
var Bullet_Bullet = /*#__PURE__*/function () {
  ...
  Bullet_createClass(Bullet, [{
     ...
     *
     * Appends list to previous list element, if
     * none exist it wraps the list in a new list element.
     *
     ...
     * @method findList
     *
     * Finds an existing list in list element
     *
     * @param {HTMLNode} ListItem
     * @return {Array[]}
     */
     ...
     *
     * Finds all list element siblings that follow it
     *
     * @param {HTMLNode} ListItem
     * @return {HTMLNode}
     */
...
var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
   ...
   * @param {enum} resultAction Action to be applied in that element.
   */
...
var Clipboard_Clipboard = /*#__PURE__*/function () {
  ...
  Clipboard_createClass(Clipboard, [{
    ...
    value: function pasteByEvent(event) {
      ...
      if (clipboardData && clipboardData.elements && clipboardData.elements.length) {
        var element = clipboardData.elements.length > 1 ? clipboardData.elements[1] : lists.head(clipboardData.elements);

        if (element.kind === 'file' && element.type.indexOf('image/') !== -1) {
          // paste img file
          this.context.invoke('editor.insertImagesOrCallback', [element.getAsFile()]);
          event.preventDefault();
        ...
        if (dataTransfer && dataTransfer.files && dataTransfer.files.length) {
          ...
          external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(dataTransfer.types, function (idx, type) {
            ...
            if (type.toLowerCase().indexOf('text') > -1) {
              ...
              external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(content).each(function (idx, element) {
                _this.context.invoke('editor.insertNode', element);
              });
            }
          });
        }
  ...
  Buttons_createClass(Buttons, [{
      ...
      return this.ui.buttonGroup({
        ...
        children: [this.button({
          ...
          callback: function callback($dropdown) {
            ...
            $dropdown.find('.note-holder-custom').each(function (idx, element) {
              var $holder = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(element);
              $holder.append(_this.ui.palette({
                colors: customColors,
            ...
            $dropdown.find('input[type=color]').each(function (idx, element) {
              external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(element).change(function () {
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.style', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          elements: _this2.options.styleTags,
          ...
          template: function template(element) {
            ...
            if (typeof element === 'string') {
              element = {
                tag: element,
                title: Object.prototype.hasOwnProperty.call(_this2.lang.style, element) ? _this2.lang.style[element] : element
              };
            }
      ...
      var _loop = function _loop(styleIdx, styleLen) {
        var element = _this2.options.styleTags[styleIdx];

        _this2.context.memo('button.style.' + element, function () {
          return _this2.button({
            className: 'note-btn-style-' + element,
            contents: '<div data-value="' + element + '">' + element.toUpperCase() + '</div>',
            tooltip: _this2.lang.style[element],
            click: _this2.context.createInvokeHandler('editor.formatBlock')
          }).render();
        });
      };
      ...
      this.context.memo('button.fontname', function () {
        ...
        return _this2.ui.buttonGroup([_this2.button({
          ...
          elements: _this2.options.fontNames.filter(_this2.isFontInstalled.bind(_this2)),
          title: _this2.lang.font.name,
          template: function template(element) {
            return '<span style="font-family: ' + env.validFontName(element) + '">' + element + '</span>';
          },
      ...
      this.context.memo('button.fontsize', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          checkClassName: _this2.options.icons.menuCheck,
          elements: _this2.options.fontSizes,
      ...
      this.context.memo('button.fontsizeunit', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          checkClassName: _this2.options.icons.menuCheck,
          elements: _this2.options.fontSizeUnits,
      ...
      this.context.memo('button.height', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          elements: _this2.options.lineHeights,
          checkClassName: _this2.options.icons.menuCheck,
      ...
      this.context.memo('button.table', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          elements: ['<div class="note-dimension-picker">', '<div class="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"></div>', '<div class="note-dimension-picker-highlighted"></div>', '<div class="note-dimension-picker-unhighlighted"></div>', '</div>', '<div class="note-dimension-display">1 x 1</div>'].join('')
        })], {
    ...
    value: function updateCurrentStyle($container) {
      ...
      if (styleInfo['font-family']) {
        ...
        $cont.find('.dropdown-fontname a').each(function (idx, element) {
          var $element = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(element); // always compare string to avoid creating another func.

          var isChecked = $element.data('value') + '' === fontName + '';
          $element.toggleClass('checked', isChecked);
        });
      ...
      if (styleInfo['font-size']) {
        ...
        $cont.find('.dropdown-fontsize a').each(function (idx, element) {
          var $element = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(element); // always compare with string to avoid creating another func.

          var isChecked = $element.data('value') + '' === fontSize + '';
          $element.toggleClass('checked', isChecked);
        });
        $cont.find('.note-current-fontsize').text(fontSize);
        var fontSizeUnit = styleInfo['font-size-unit'];
        $cont.find('.dropdown-fontsizeunit a').each(function (idx, element) {
          var $element = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(element);
          var isChecked = $element.data('value') + '' === fontSizeUnit + '';
          $element.toggleClass('checked', isChecked);
        });
      ...
      if (styleInfo['line-height']) {
        ...
        $cont.find('.dropdown-line-height li a').each(function (idx, element) {
          // always compare with string to avoid creating another func.
          var isChecked = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(element).data('value') + '' === lineHeight + '';
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function createShortcutList() {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div><div class="help-list-element"></div></div>');
...
var HintPopover_HintPopover = /*#__PURE__*/function () {
  ...
  HintPopover_createClass(HintPopover, [{
    ...
    value: function initialize() {
      ...
      this.$content.on('click', '.note-hint-element', function (e) {
    ...
    value: function selectItem($element) {
      ...
      this.$content[0].scrollTop = $element[0].offsetTop - this.$content.innerHeight() / 2;
    }
  }, {
    key: "moveDown",
    value: function moveDown() {
      var $current = this.$content.find('.note-hint-element.active');
      ...
      if ($next.length) {
        ...
        this.selectItem($nextGroup.find('.note-hint-element').first());
      }
    }
  }, {
    key: "moveUp",
    value: function moveUp() {
      ...
      if ($prev.length) {
        ...
        this.selectItem($prevGroup.find('.note-hint-element').last());
      }
    }
  }, {
    key: "replace",
    value: function replace() {
      var $element = this.$content.find('.note-hint-element.active');

      if ($element.length) {
        var node = this.nodeFromItem($element); // If matchingWord length = 0 -> capture OK / open hint / but as mention capture "" (\w*)
    ...
    key: "nodeFromItem",
    value: function nodeFromItem($element) {
      var hint = this.hints[$element.data('index')];
      var element = $element.data('element');
      var node = hint.content ? hint.content(element) : element;
    ...
    value: function createItemTemplates(hintIdx, elements) {
      var hint = this.hints[hintIdx];
      return elements.map(function (element
      /*, idx */
      ) {
        var $element = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div class="note-hint-element"/>');
        $element.append(hint.template ? hint.template(element) : element + '');
        $element.data({
          'index': hintIdx,
          'element': element
        });
    ...
    value: function createGroup(idx, keyword) {
      ...
      this.searchKeyword(idx, keyword, function (elements) {
        elements = elements || [];

        if (elements.length) {
          $group.html(_this3.createItemTemplates(idx, elements));
      ...
      if (!lists.contains([core_key.code.ENTER, core_key.code.UP, core_key.code.DOWN], e.keyCode)) {
        ...
        if (this.hints.length && keyword) {
          ...
          if (bnd) {
            ...
            }); // select first .note-hint-element

            this.$content.find('.note-hint-element:first').addClass('active'); // set position for popover after group is created
...
var dropdown = renderer["a" /* default */].create('<div class="note-dropdown-menu" role="list">', function ($node, options) {
  var markup = Array.isArray(options.elements) ? options.elements.map(function (element) {
    var value = typeof element === 'string' ? element : element.value || '';
    var content = options.template ? options.template(element) : element;
    var $temp = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<a class="note-dropdown-element" href="#" data-value="' + value + '" role="listelement" aria-label="' + value + '"></a>');
    $temp.html(content).data('element', element);
    return $temp;
  }) : options.elements;
  $node.html(markup).attr({
    'aria-label': options.title
  });
  $node.on('click', '> .note-dropdown-element', function (e) {
    ...
    if (element.click) {
      element.click($a);
    } else if (options.elementClick) {
      options.elementClick(e, element, value);
    }
  });
...
var dropdownCheck = renderer["a" /* default */].create('<div class="note-dropdown-menu note-check" role="list">', function ($node, options) {
  var markup = Array.isArray(options.elements) ? options.elements.map(function (element) {
    var value = typeof element === 'string' ? element : element.value || '';
    var content = options.template ? options.template(element) : element;
    var $temp = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<a class="note-dropdown-element" href="#" data-value="' + value + '" role="listelement" aria-label="' + element + '"></a>');
    $temp.html([icon(options.checkClassName), ' ', content]).data('element', element);
    return $temp;
  }) : options.elements;
  $node.html(markup).attr({
    'aria-label': options.title
...
var paragraphDropdownButton = function paragraphDropdownButton(opt) {
  return buttonGroup([ui_button({
    ...
    className: 'note-align',
    children: opt.elements[0]
  }), buttonGroup({
    className: 'note-list',
    children: opt.elements[1]
  })])]).render();
};
  ...
  return buttonGroup([ui_button({
    ...
    callback: function callback($node) {
      ...
      $catcher.css({
        width: opt.col + 'em',
        height: opt.row + 'em'
      }).mousedown(opt.elementClick).mousemove(function (e) {
    ...
    children: [ui_button({
      ...
      click: function click(event) {
        ...
        if (eventName && value) {
          ...
          if (type === 'fore') {
            opt.elementClick('foreColor', value);
          } else if (type === 'back') {
            opt.elementClick('backColor', value);
          } else {
            opt.elementClick(eventName, value);
          }
        }
      }
    })]

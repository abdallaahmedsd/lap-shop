...
interface Tools {
    ...
    makeMap: <T>(elements: ArrayLike<T> | string, delim?: string | RegExp, map?: Record<string, T | string>) => Record<string, T | string>;
    each: {
...
interface DomQuery<T extends Node = Node> extends ArrayLike<T> {
    ...
    length: number;
    selector: string;
    add(elements: Array<string | T> | DomQuery<T>, sort?: boolean): this;
    ...
    filter(selector: string | ((i: number, element: any) => boolean)): this;
    ...
    html(): string;
    is(selector: string | ((i: number, element: any) => boolean)): boolean;
    last(): this;
...
interface BaseFormat<T> {
    ...
    onmatch?: (node: Node, fmt: T, elementName: string) => boolean;
...
interface NestedFormatting {
    title: string;
    elements: Array<FormatReference | StyleFormat>;
}
...
interface DialogFooterMenuButtonSpec extends BaseDialogFooterButtonSpec {
    ...
    tooltip?: string;
    icon?: string;
    elements: DialogFooterMenuButtonItemSpec[];
}
...
interface I18n {
    ...
    getCode: () => string;
    add: (code: string, elements: Record<string, string>) => void;
...
interface EditorManager extends Observable<EditorManagerEventMap> {
    ...
    addI18n: (code: string, element: Record<string, string>) => void;

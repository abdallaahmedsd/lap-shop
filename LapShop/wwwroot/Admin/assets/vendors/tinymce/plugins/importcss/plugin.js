...
(function () {
    ...
    var generate = function () {
      ...
      var groupOrder = [];
      var groups = {};
      var addItemToGroup = function (groupTitle, elementInfo) {
        if (groups[groupTitle]) {
          groups[groupTitle].push(elementInfo);
        } else {
          groupOrder.push(groupTitle);
          groups[groupTitle] = [elementInfo];
        }
      };
      var addItem = function (elementInfo) {
        ungroupedOrder.push(elementInfo);
      };
      var toFormats = function () {
        var groupItems = bind(groupOrder, function (g) {
          var elements = groups[g];

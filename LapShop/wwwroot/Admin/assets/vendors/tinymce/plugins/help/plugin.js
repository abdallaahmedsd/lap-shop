...
(function () {
    ...
    var urls = map([
      ...
      return __assign(__assign({}, element), {
        type: element.type || openSourceType,
        slug: element.slug || element.key
      });
    });

...
(function () {
    ...
    var charmapFilter = function (charmap) {
      return global$1.grep(charmap, function (element) {
        return isArray(element) && element.length === 2;
      });
    };
    ...
    var open = function (editor, charMap) {
      ...
      var scanAndSet = function (dialogApi, pattern) {
        find(charMap, function (group) {
          ...
          var elements = scan(f, pattern);
          dialogApi.setData({ results: elements });
        });
      };
      var SEARCH_DELAY = 40;

...
namespace LapShop.Migrations
{
    ...
    [Migration("20240820064605_ConvertingRamToNewTypeColumnWithReferenceial")]
    partial class ConvertingRamToNewTypeColumnWithReferenceial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LapShop.Models.TbGPU", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.TbHardDisk", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.TbOs", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Models.TbProcessor", b =>
                {
                    b.Property<int>("ProcessorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Models.TbRAM", b =>
                {
                    b.Property<int>("RAMId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Models.TbScreenResolution", b =>
                {
                    b.Property<int>("ScreenResolutionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Models.TbItem", b =>
                {
                    ...
                    b.HasOne("LapShop.Models.TbGPU", "GPU")
                        .WithMany("Items")
                        .HasForeignKey("GPUId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("LapShop.Models.TbHardDisk", "HardDisk")
                        .WithMany("Items")
                    ...
                    b.HasOne("LapShop.Models.TbOs", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("LapShop.Models.TbProcessor", "Processor")
                        .WithMany("Items")
                    ...
                    b.HasOne("LapShop.Models.TbRAM", "RAM")
                        .WithMany("Items")
                        .HasForeignKey("RAMId")
                        .HasConstraintName("FK_TbItems_TbRAMs");

                    b.HasOne("LapShop.Models.TbScreenResolution", "ScreenResolution")
                        .WithMany("Items")
